...
from .forms import ProductForm, brandLoginForm, brandProfileForm, brandRegistrationForm
...
def update_product(request, product_id):
    ...
    return render(request, 'brand/update_product.html', {'form': form, 'product': product})
...
def view_feedbacks(request):
    ...
    feedbacks = Feedback.objects.filter(product__brand=request.user.brand).select_related('product', 'customer')
    
    return render(request, 'brand/view_feedbacks.html', {
        'feedbacks': feedbacks,
    })
...
def view_sell_history(request):
    ...
    sell_history = Order.objects.filter(product__brand=brand).select_related('product', 'user')
    
    return render(request, 'brand/view_sell_history.html', {
